...
function ver_filetasks(class,task, course, section){
    ...
    $.ajax({
        ...
        headers: token ,
        data: {course_id:course,section_id:section,_token:token,task_id:task,class_id:class},
        type:'POST',
        datatype:'json',
        success:function(data)
        {
