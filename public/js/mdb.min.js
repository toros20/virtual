...
function eliminar_task(task, course, section){
    ...
    var curso_actual_task =$("#curso_actual").val();
    var section_actual_task =$("#section_actual").val();
    var clase_actual_task =$("#clase_actual").val();
    var parcial = $("#txt_parcial_actual").val();
    var token = $("#token").val();
    ...
    $.ajax({
        ...
        headers: token ,
        data: {course_id:course,section_id:section,_token:token,task_id:task,parcial_id:parcial},
        type:'POST',
        datatype:'json',
        success:function(data)
        {
