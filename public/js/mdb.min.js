...
function loadclassesfordocente(){
    ...
    $.ajax({
        ...
        url:'../../../../../../ajax/loadclassesfordocente',
        headers: token ,
        data: {course_id:course,_token:token,user:user_id},
        type:'POST',
        datatype:'json',
        success:function(data)
        {  
            //console.log(response);
            $('#select_clases').html(data);
...
function loadsectionsfordocentes(){

    //obtenemos  el id del curso, de la clase y del usuario
     var course = $("#select_course").val();
    ...
    $.ajax({
        ...
        url:'../../../../../../ajax/loadsectionsfordocentes',
        headers: token ,
        data: {course_id:course,clase_id:clase,_token:token,user:user_id},
        type:'POST',
        datatype:'json',
        success:function(data)
        {
            //console.log(response);
            $('#checks_sections').html(data);
...
//funcion que se activa al llenar el formulario de creacion de acumulativos 
function send_task(){

    //obtenemos todos los campos del formulario lleno
    var course = $("#select_course").val();
    var clase = $("#select_clases").val();
    var tipo = $("#select_tipo").val();
    var parcial = $("#select_parcial").val();
    var titulo = $("#titulo").val();
    var descripcion = $("#descripcion").val();
    var valor = $("#valor").val();
    var fecha_entrega = $("#date-picker-example").val();
    var user_id = $("#user_id").val(); //docente que crea la tarea
    var token = $("#token").val();
    //obtenemos los value de los checkbox seleccionados
    let secciones = [];
    $("input[type=checkbox]:checked").each(function(){
        secciones.push(this.value);
    });

    //obtenemos los datos del curso seccion y clase actual, para volver aqui mismo
    var curso_actual =$("#curso_actual").val();
    var section_actual =$("#section_actual").val();
    var clase_actual =$("#clase_actual").val();

    if (course==-1 ||clase ==-1 || tipo==-1 || parcial==-1 || titulo=='' || descripcion==''|| valor=='') {
        ...
        toastr.options = {
          ...
          toastr.error('Debe llenar todos los datos');
        }else{
            ...
            $.ajax({
                ...
                data: {
                    ...
                    _token:token,
                    _user:user_id,
                    //las siguiente variables es para poder volver a este curso seccion y clase
                    _curso_actual:curso_actual,
                    _section_actual:section_actual,
                    _clase_actual:clase_actual },
                type:'POST',
                datatype:'json',

                beforeSend: function(){
                    $('#btn_send_task').attr("disabled", true);
                ...
                /* Ian Jose antunes 11 A  josepera0001@hotmail.com */
                ...
                success:function(data)
                {
                    ...
                    toastr.options = {
                      ...
                      toastr.success('Acumulativo Creado Exitosamente');
                      $('#btn_send_task').attr("disabled", false);
                },
                error: function (response) {
                    console.log(response);
                }
...
//funcion para filtrar los acumulativos y los recursos segun la clase selecciona en el panel derecho de los students en el area de acumulativos
function acumulativosbyclass(clase){

    //obtenemos los datos que se requiere
    var student = $("#txt_user").val();
    var parcial = $("#txt_parcial").val();
    var token = $("#token").val();
    var clase_id = clase;

    $.ajax({

        url:'../../../../../ajax/acumulativosbyclass',
        headers: token ,
        data: {_parcial:parcial,_clase_id:clase_id,_token:token,_student:student},
        type:'POST',
        datatype:'json',
        beforeSend: function(){
            $('#circle').show();
...
//*********** */codigos para la seccion de subir archivos*//////////////////////

//codigo para cargar solo las clases asignadas al curso seleccionado al momento de subir documentos
function loadclassesfordocente_file(){

    var course = $("#select_course_file").val();
    var user_id = $("#user_id").val();
    var token = $("#token").val();
...
//codigo para cargar solo las seccione asignadas al docente seleccionado al momento de subir documentos
function loadsectionsfordocentes_file(){

     //obtenemos  el id del curso, de la clase y del usuario
     var course = $("#select_course_file").val();
     var clase = $("#select_clases_file").val();
     var user_id = $("#user_id").val();
     var token = $("#token").val();
    ...
    $.ajax({
        ...
        {
            //console.log(response);
            $('#checks_sections_file').html(data);
...
function send_file(){
   ...
   var parcial = $("#select_parcial_file").val();
   var file = $("#file").val();
   ...
   $.ajax({
       ...
       url:'../../../../../../ajax/send_file',
       headers: token ,
       data: {course_id:course,clase_id:clase,_token:token,user:user_id,parcial_id:parcial,desc:descripcion,document:file},
       type:'POST',
       datatype:'json',
       success:function(data)
       {
...
//codigo para cargar solo las seccione asignadas al docente seleccionado al momento de subir videos
function loadclassesfordocente_video(){

    var course = $("#select_course_video").val();
    var user_id = $("#user_id").val();
    var token = $("#token").val();
...
function loadsectionsfordocentes_video(){

     //obtenemos  el id del curso, de la clase y del usuario
     var course = $("#select_course_video").val();
     var clase = $("#select_clases_video").val();
     var user_id = $("#user_id").val();
     var token = $("#token").val();
    ...
    $.ajax({
        ...
        {
            //console.log(response);
            $('#checks_sections_video').html(data);
...
//funcion para eliminar un acumulativo desde el panel acumulativos de docentes
function eliminar_task(task, course, section){
    ...
    $.ajax({
        ...
        headers: token ,
        data: {course_id:course,section_id:section,_token:token,task_id:task},
        type:'POST',
        datatype:'json',
        success:function(data)
        {
            ...
            toastr.options = {
              ...
              toastr.error('El acumulativo ha sido Eliminado');
              location.reload();
...
//funcion para eliminar un archivo desde el panel acumulativos de docentes
    ...
    $.ajax({
        ...
        success:function(data)
        {
            ...
            toastr.options = {
              ...
              toastr.error('El Archivo ha sido Eliminado');
              location.reload();
...
//funcion para eliminar un video desde el panel acumulativos de docentes
...
//funccion para evaluar el acumulativo seleccionado
function evaluar_task(task, course, section){
    
    var token = $("#token").val();

    $.ajax({

        url:'../../../../../../ajax/evaluar_task',
        headers: token ,
        data: {course_id:course,section_id:section,_token:token,task_id:task},
        type:'POST',
        datatype:'json',
        ...
        {
            //console.log(response);
            $('#div_modal_evaluar').html(data);
            $('#centralModalevaluar').modal({
                show: true
                })
...
//funciones para el calculo de notas totales por parciales en el area de examen del docente
	
/* function calcular_semestre1(m_id){

     var t_aula =  document.getElementById('inputa1_'+m_id).value
     var t_casa = document.getElementById('inputc1_'+m_id).value
     var examen1 = document.getElementById('inpute1_'+m_id).value
     var nivelacion1 = document.getElementById('inputn1_'+m_id).value

     var p1 = eval(t_aula)+eval(t_casa)+eval(examen1)+eval(nivelacion1);
        if (p1>100) {
            alert("CUIDADO !! El Total se pasa de 100 puntos")
            document.getElementById('p1_'+m_id).value =0;
        }else{
            document.getElementById('p1_'+m_id).value =p1;
        } ;
}

function calcular_semestre2(m_id){

     var t_aula2 = document.getElementById('inputa2_'+m_id).value
     var t_casa2 = document.getElementById('inputc2_'+m_id).value
     var examen2 = document.getElementById('inpute2_'+m_id).value

       var t_aula1 = document.getElementById('inputa1_'+m_id).value
      var t_casa1 = document.getElementById('inputc1_'+m_id).value
      var examen1 = document.getElementById('inpute1_'+m_id).value
      var nivelacion1 = document.getElementById('inputn1_'+m_id).value
     
    
        var p2 = eval(t_aula2)+eval(t_casa2)+eval(examen2);
        if (p2>100) {
            alert("CUIDADO !! El Total se pasa de 100 puntos")
            document.getElementById('p2_'+m_id).value =0;
        }else{
            document.getElementById('p2_'+m_id).value =p2;
        } ;

        
        //var t1= document.getElementById('p1_'+m_id).value
        //var t2= document.getElementById('p2_'+m_id).value

        var t1=eval(t_aula1)+eval(t_casa1)+eval(examen1)+eval(nivelacion1);
        var t2=eval(t_aula2)+eval(t_casa2)+eval(examen2);
        
        // CODIGO PARA QUE APARESCA EL PROMEDIO
        var prom = Math.round( ((t1+t2)/2),2);
        //var prom = (eval(t1)+eval(t2))/2;
        document.getElementById('promedio'+m_id).value =Math.round(prom,2);
        //document.getElementById('promedio'+m_id).value =prom;
    
} */

function calcular_1P(m_id){
    
     
     var acum1 = document.getElementById('acum1_'+m_id).value
     var examen1 = document.getElementById('exa1_'+m_id).value
    
    var p1 = eval(acum1)+eval(examen1);
    if (p1>100) {
        alert("CUIDADO !! El Total se pasa de 100 puntos")
        document.getElementById('total1_'+m_id).value =0;
    }else{
        document.getElementById('total1_'+m_id).value =p1;
    } ;
    
}

function calcular_2P(m_id){
    
     
    var acum2 = document.getElementById('acum2_'+m_id).value
    var examen2 = document.getElementById('exa2_'+m_id).value
   
   var p2 = eval(acum2)+eval(examen2);
   if (p2>100) {
       alert("CUIDADO !! El Total se pasa de 100 puntos")
       document.getElementById('total2_'+m_id).value =0;
   }else{
       document.getElementById('total2_'+m_id).value =p2;
   } ;
   
}

function calcular_3P(m_id){
    
     
    var acum3 = document.getElementById('acum3_'+m_id).value
    var examen3 = document.getElementById('exa3_'+m_id).value
   
   var p3 = eval(acum3)+eval(examen3);
   if (p3>100) {
       alert("CUIDADO !! El Total se pasa de 100 puntos")
       document.getElementById('total3_'+m_id).value =0;
   }else{
       document.getElementById('total3_'+m_id).value =p3;
   } ;
   
}


function calcular_4P(m_id){

    var acum4 = document.getElementById('acum4_'+m_id).value
    var examen4 = document.getElementById('exa4_'+m_id).value
    
    var p4 = eval(acum4)+eval(examen4);
    if (p4>100) {
        alert("CUIDADO !! El Total se pasa de 100 puntos")
        document.getElementById('total4_'+m_id).value =0;
    }else{
        document.getElementById('total4_'+m_id).value =p4;
    } ;
    
        
        var t1 = 
        eval(document.getElementById('acum1_'+m_id).value) + 
        eval(document.getElementById('exa1_'+m_id).value);
       
        var t2 = 
        eval(document.getElementById('acum2_'+m_id).value) + 
        eval(document.getElementById('exa2_'+m_id).value);

        var t3 = 
        eval(document.getElementById('acum3_'+m_id).value) + 
        eval(document.getElementById('exa3_'+m_id).value);

        var t4 = 
        eval(document.getElementById('acum4_'+m_id).value) + 
        eval(document.getElementById('exa4_'+m_id).value) ;
 

        // CODIGO PARA QUE APARESCA EL PROMEDIO
        var prom = (eval(t1)+eval(t2)+eval(t3)+eval(t4))/4;
        
        document.getElementById('promedio_'+m_id).value =Math.round(prom,2);
}

//funcion para mostrar la boleta de calificaciones 
function boletas(){
