                                ...
                                @foreach ($clases as $clase)
                                    ...
                                    @if ($cont%2==0 ) 
                                        <tr style="border: 1px solid #dee2e6; background-color:#f2f2f2;">
                                            ...
                                            {{-- I PARCIAL --}}
                                            @if ( $nota1 < 36)
                                                 <td style="border: 1px solid #dee2e6; text-align:center; width:50px; padding:0.35rem;">{{$nota1}} Insuficiente</td>
                                            @endif
                                            @if ( $nota1 > 35 && $nota1 < 70)
                                                 <td style="border: 1px solid #dee2e6; text-align:center; width:50px; padding:0.35rem;">{{$nota1}}Necesita Mejorar</td>
                                            @endif
                                            ...
                                            @endif
                                            @if ( $nota1 > 90)
                                                 <td style="border: 1px solid #dee2e6; text-align:center; width:50px; padding:0.35rem;">{{$nota1}}Avanzado</td>
                                            @endif
