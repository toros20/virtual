        ...
        <div class="row" align="center"> 
                ...
                <?php $historial = 'historial_'.$curso.'_'.$seccion; ?>
                        ...
                        @if ($course->is_semestral == 0)
                            ...
                            <table class="tabla tabla-striped tabla-bordered"  style="margin-top:10px; border: 1px solid #dee2e6; "  align="center" width="700">
                                ...
                                @else
                                    <tr style="border: 1px solid #dee2e6; ">
                                        ...
                                        <th style="border: 1px solid #dee2e6; text-align:center;  padding:0.35rem; font-weight: bold">III P</th>
                                        <th style="border: 1px solid #dee2e6; text-align:center;  padding:0.35rem; font-weight: bold">IV P</th>
                                        <th style="border: 1px solid #dee2e6; text-align:center;  padding:0.35rem; font-weight: bold">PROM.</th>
                                        <th style="border: 1px solid #dee2e6; text-align:center;  padding:0.35rem; font-weight: bold">RECU.</th>
                                    </tr>
                                @endif
                                    ...
                                    @if ($course->id > 8)
                                        ...
                                        @if ($cont%2==0 ) 
                                            ...
                                            <tr style="border: 1px solid #dee2e6; background-color:#f2f2f2;">
                                                ...
                                                {{-- I PARCIAL --}}
                                                @if ( $nota1 < 36)
                                                    <td style="border: 1px solid #dee2e6; text-align:center;  padding:0.35rem;">{{$nota1}}</td>
                                                @endif
                                                @if ( $nota1 > 35 && $nota1 < 70)
                                                    <td style="border: 1px solid #dee2e6; text-align:center;  padding:0.35rem;">{{$nota1}}</td>
                                                @endif
                                                ...
                                                {{-- II PARCIAL --}}
                                                 @if ( $nota2 < 36)
                                                    <td style="border: 1px solid #dee2e6; text-align:center;  padding:0.35rem;">{{$nota2}}</td>
                                                @endif
                                                @if ( $nota2 > 35 && $nota2 < 70)
                                                    <td style="border: 1px solid #dee2e6; text-align:center;  padding:0.35rem;">{{$nota2}}</td>
                                                @endif
                                                ...
                                                @endif
                                                {{--  @if ( ($resultado[0]->Acum2) + ($resultado[0]->Exa2) < 70)
                                                        <td style="border: 1px solid #dee2e6; text-align:center;  color:red; padding:0.35rem;">{{($resultado[0]->Acum2) + ($resultado[0]->Exa2)}}</td>
                                                    @else 
                                                        <td style="border: 1px solid #dee2e6; text-align:center; width:50px; padding:0.35rem;">{{($resultado[0]->Acum2) + ($resultado[0]->Exa2)}}</td>
                                                    @endif --}}
                            ...
                            {{-- <tr style="border: 1px solid #dee2e6; ">
                                <th style="text-align:center; width:5px;font-weight: bold;">* </th>
                                <th style="font-weight: bold;">PROMEDIO DE PARCIAL</th>
                                <th style="text-align:center; width:50px;font-weight: bold; border: 1px solid #dee2e6;"></th>
                                <th style="text-align:center; width:50px;font-weight: bold; border: 1px solid #dee2e6;">IIP</th>
                                <th style="text-align:center; width:50px;font-weight: bold; border: 1px solid #dee2e6;"></th>
                                <th style="text-align:center; width:50px;font-weight: bold; border: 1px solid #dee2e6;"></th>
                            ...
                            <table class="tabla tabla-striped tabla-bordered"  style="margin-top:10px; border: 1px solid #dee2e6; "  align="center" width="700">
                                ...
                                @if ($cont%2==0 ) 
                                    <tr style="border: 1px solid #dee2e6; background-color:#f2f2f2;">
                                       ...
                                       @if ($promedio < 70 and $promedio > 0)
                                            <td style="border: 1px solid #dee2e6; text-align:center; width:50px; color:red; padding:0.35rem;">{{ $promedio }}</td>
                                        @endif 
                                        @if ($promedio > 69 )
                                            <td style="border: 1px solid #dee2e6; text-align:center; width:50px; padding:0.35rem;">{{ $promedio }}</td>
                                        @endif
                                        @if ($promedio == 0 )
                                            <td style="border: 1px solid #dee2e6; text-align:center; width:50px; padding:0.35rem;"></td>
                                        @endif 
