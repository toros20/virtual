      ...
      <div class="container-fluid" align="center">
        ...
        <div class="row" align="center"> 
                ...
                @foreach ($estudiantes as $estudiante)
                        ...
                        <table  style=" text-align:center; border: 1px solid #000; "  align="center" width="700">
                            <tr style="border: 1px solid #000; "> <td style=" border: 1px solid #000;"><h5>BOLETA DE CALIFICACIONES</h5></td>
                                <td style=" border: 1px solid #000;"><?php echo $arrayDias[date('w')]." ".date('d')."/".$arrayMeses[date('m')-1]."/".date('Y');?></td></tr>
                            <tr style="border: 1px solid #000; ">
                                <td style="padding-top:5px;  border: 1px solid #000;">
                        ...
                        <table class="tabla tabla-striped tabla-bordered"  style=" text-align:center; border: 1px solid #000; "  align="center" width="700">
                            <tr style="border: 1px solid #000; "><td ><h4 style="font-weight: bold;"> {{$estudiante->name}} {{$estudiante->lastname}}</h4></td></tr>
                        </table>
                        <table class="tabla tabla-striped tabla-bordered"  style="margin-top:10px; border: 1px solid #000; "  align="center" width="700">
                                <tr style="border: 1px solid #000; "><th style="text-align:center; width:5px;font-weight: bold;">No. </th>
                        ...
                        <table style="border: 1px solid #000;" class="tabla tabla-striped tabla-bordered"  align="center" width="700"> 
                        ...
                        ?>
                            ...
                            <tr style="border: 1px solid #000; ">
                                <td style="border: 1px solid #000; font-weight: bold; width:5px; padding:0.35rem;"><?php echo $cont+1; ?></td>
                                <td style="border: 1px solid #000; text-align:left;padding:0.35rem;">{{$resultado[0]->clase}}</td>
                                @if ( ($resultado[0]->Acum1) + ($resultado[0]->Exa1) < 70)
                                    <td style="border: 1px solid #000; text-align:center; width:50px; color:red; padding:0.35rem;">{{($resultado[0]->Acum1) + ($resultado[0]->Exa1)}}</td>
                                @else 
                                    <td style="border: 1px solid #000; text-align:center; width:50px; padding:0.35rem;">{{($resultado[0]->Acum1) + ($resultado[0]->Exa1)}}</td>
                                @endif
                                
                                <td style="text-align:center; width:50px ;padding:0.35rem; border: 1px solid #000;">{{-- {{($resultado[0]->Acum2) + ($resultado[0]->Exa2)}}--}}</td> 
                                <td style="text-align:center; width:50px ;padding:0.35rem; border: 1px solid #000;">{{--{{($resultado[0]->Acum3) + ($resultado[0]->Exa3)}}--}}</td>
                                <td style="text-align:center; width:50px ;padding:0.35rem; border: 1px solid #000;">{{--{{($resultado[0]->Acum4) + ($resultado[0]->Exa4)}}--}}</td>
                                <td style="text-align:center; width:50px ;padding:0.35rem; border: 1px solid #000;">
                                   {{--  (
                                ...
                                <td style="text-align:center; width:50px; border: 1px solid #000;">{{--{{$resultado[0]->Recu1}}--}}</td>
                            </tr>
                          <?php $cont+=1;?>
                        @endforeach {{-- fin del foreach de cada clase --}}
                    </table>
                    <table class="tabla tabla-striped tabla-bordered"  style="margin-bottom:20px; border: 1px solid #000;"  align="center" width="700">
                        <?php $promedio1=$total1/$cont; ?>
                            <tr style="border: 1px solid #000; ">
                                    <td style="font-weight: bold;">PROMEDIO DE PARCIAL</td>
                                    <td style="text-align:center; width:50px;font-weight: bold; padding:0.5rem; border: 1px solid #000;"><?php echo round($promedio1)?></td>
                                    <td style="text-align:center; width:50px;font-weight: bold; padding:0.5rem; border: 1px solid #000;"><?php //echo Round(($total2/$cont),2)?></td>
                                    <td style="text-align:center; width:50px;font-weight: bold; padding:0.5rem; border: 1px solid #000;"><?php //echo Round(($total3/$cont),2)?></td>
                                    <td style="text-align:center; width:50px;font-weight: bold; padding:0.5rem; border: 1px solid #000;"><?php //echo Round(($total4/$cont),2)?></td>
                                    <td style="text-align:center; width:50px;font-weight: bold; padding:0.5rem; border: 1px solid #000;"></td>
                                    <td style="text-align:center; width:50px;font-weight: bold; padding:0.5rem; border: 1px solid #000;"></td>
                                </tr>
                        </table>
                        ...
                        ?>
                      <table style="margin-top:10px; font-size:1.25rem; border: 1px solid #000;"  align="center" width="700">
                            <tr style="border: 1px solid #000; ">
                                <th style="text-align:center; width:100px ;font-weight: bold; padding:0.25rem; border: 1px solid #000;">Personalidad</th>
                                <th style="text-align:center; width:150px ;font-weight: bold; padding:0.25rem; border: 1px solid #000;">I P</th>
                                <th style="text-align:center; width:150px ;font-weight: bold; padding:0.25rem; border: 1px solid #000;">II P</th>
                                <th style="text-align:center; width:150px ;font-weight: bold; padding:0.25rem; border: 1px solid #000;">III P</th>
                                <th style="text-align:center; width:150px ;font-weight: bold; padding:0.25rem; border: 1px solid #000;">IV P</th>
                            </tr>
                            <tr style="border: 1px solid #000; ">
                                <th style="width:300px; padding:0.25rem; ">Puntualidad</th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"><?php echo $c1_parcial1; ?></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                            </tr>
                            <tr style="border: 1px solid #000; ">
                                <th style="width:300px; padding:0.25rem; ">Espíritu de Trabajo</th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"><?php echo $c2_parcial1; ?></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                            </tr>
                            <tr style="border: 1px solid #000; ">
                                ...
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"><?php echo $c3_parcial1; ?></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                            </tr>
                            <tr style="border: 1px solid #000; ">
                                ...
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"><?php echo $c4_parcial1; ?></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                            </tr>
                            <tr style="border: 1px solid #000; ">
                                ...
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"><?php echo $c5_parcial1; ?></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                            </tr>
                            <tr style="border: 1px solid #000; ">
                                ...
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"><?php echo $c6_parcial1; ?></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                                <th style="width:100px; padding:0.25rem; text-align:center; border: 1px solid #000;"></th>
                            </tr>
                        ...
                        <table   style="margin-top:10px; border: 1px solid #000;"  align="center" width="700"> 
                                <tr style="border: 1px solid #000; ">
                                        <th style="text-align:center; width:100px;border: 1px solid #000; "></th>
                                        <th style="text-align:center; width:150px;border: 1px solid #000;"></th>
                                        <th style="text-align:center; width:150px;border: 1px solid #000;"></th>
                                        <th style="text-align:center; width:150px;border: 1px solid #000;"></th>
                                        <th style="text-align:center; width:150px;border: 1px solid #000;"></th>
                                    </tr>
                            <tr style="border: 1px solid #000; ">
                                <td style="width:300px;border: 1px solid #000;">Número de Reportes</td>
                                <td style="text-align:center; width:100px;border: 1px solid #000;"><?php echo $personalidad[0]->reportes; ?></td>
                                <td style="text-align:center; width:100px;border: 1px solid #000;"></td>
                                <td style="text-align:center; width:100px;border: 1px solid #000;"></td>
                                <td style="text-align:center; width:100px;border: 1px solid #000;"></td>
                            </tr>
                        </table>
