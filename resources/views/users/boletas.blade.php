                                   ...
                                   if ($personalidad[0]->clase1 == 1) {$c1_parcial1="Insuficiente";}
                                    ...
                                    <table   style="margin-top:10px; border: 1px solid #dee2e6;"  align="center" width="700"> 
                                        ...
                                        <tr style="border: 1px solid #dee2e6; ">
                                            ...
                                            <td style="text-align:center; width:100px;border: 1px solid #dee2e6;"><?php echo $personalidad_1p[0]->reportes; ?></td>
                                        ...
                                        <tr style="border: 1px solid #dee2e6; ">
                                            ...
                                            <td style="text-align:center; width:100px;border: 1px solid #dee2e6;"><?php echo $personalidad_1p[0]->inasistencias; ?></td>
