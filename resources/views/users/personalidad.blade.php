                            ...
                            <tbody id="tbody1" >
                                 @foreach ($students as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td><select style="display:inline-block" name='clase1_{{$student->user_id}}' required value="{{$resultado[0]->clase1}}"></select></td>
                                        <td><select style="display:inline-block" name='clase2_{{$student->user_id}}' required value="{{$resultado[0]->clase2}}"></select></td>
                                        <td><select style="display:inline-block" name='clase3_{{$student->user_id}}' required value="{{$resultado[0]->clase3}}"></select></td>
                                        <td><select style="display:inline-block" name='clase4_{{$student->user_id}}' required value="{{$resultado[0]->clase4}}"></select></td>
                                        <td><select style="display:inline-block" name='clase5_{{$student->user_id}}' required value="{{$resultado[0]->clase5}}"></select></td>
                                        <td><select style="display:inline-block" name='clase6_{{$student->user_id}}' required value="{{$resultado[0]->clase6}}"></select></td>
