                            ...
                            <tbody id="tbody1" >
                                 @foreach ($students as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td><input style ="width:50px" name='reporte_{{$student->user_id}}' required value="{{$resultado[0]->reportes}}" type="text"></td>
                                        <td><input style ="width:50px" name='inasistencias_{{$student->user_id}}' required value="{{$resultado[0]->inasistencias}}" type="text"></td>
