							...
							<div class="post__author author vcard inline-items">
								...
								<div class="more"><svg class="olymp-three-dots-icon"><use xlink:href="../../../../svg-icons/sprites/icons.svg#olymp-three-dots-icon"></use></svg>
									<ul class="more-dropdown" style="width:140px; margin-bottom: 5px;">
										...
										<form method="POST" action="{{ route('teachers/delete_post') }}" >
												<input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
		...
		<div class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-6 col-12">
			...
			<div class="ui-block" >
				<div style="background-color:lightcoral;" class="ui-block-title">
					<h6 style="color:white"  class="title">Tareas Asignadas Para Hoy</h6>
				</div>
				...
				<ul class="widget w-twitter">
					...
					<li class="twitter-item">
						...
						<p>{{$tarea->titulo}}</p>
							...
							<a class="btn btn-block mb-0 btn-primary" href="{{ $url = route('teachers/acumulativos/{user_id}/{course_id}/{section}/{clase}/{parcial}', [$user->id,$firstcourse->course_id,$firstcourse->section,$tarea->clase_id,$tarea->parcial])}} " class="link-post">Ver Tarea</a></p>
	...
	<div class="modal-dialog window-popup update-header-photo" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				 <form class="md-form" style="color: #757575;" enctype="multipart/form-data" method = 'POST' action="{{ route('teachers/send_image') }}">
