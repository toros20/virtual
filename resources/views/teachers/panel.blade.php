					...
					@foreach ($asignaciones as $asignacion)
						<li class="inline-items">
							...
							<div class="notification-event">
								...
								<a href="public/teachers/panel/{{$user->id}}/{{$asignacion->course->id}}/{{$asignacion->section}}" class="h6 notification-friend"> {{$asignacion->course->short_name}}-{{$asignacion->section}} </a>
