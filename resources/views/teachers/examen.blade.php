                            ...
                            <tbody id="tbody1" >
                                 @foreach ($students as $student)
                                    <tr>
                                        ...
                                        <td><input maxlength="2"  type="text" name='total1_{{$student->user_id}}' id='total1_{{$student->user_id}}' min="0" required class="form-control" value="{{ ($student->Acum1) + ($student->Exa1)}}"></td>
                                        ...
                                        <td><input maxlength="2"  type="text" name='total2_{{$student->user_id}}' id='total2_{{$student->user_id}}' min="0" required class="form-control" value="{{ ($student->Acum2) + ($student->Exa2)}} "></td>
                                        ...
                                        <td><input maxlength="2"  type="text" name='total3_{{$student->user_id}}' id='total3_{{$student->user_id}}' min="0" required class="form-control" value="{{ ($student->Acum3) + ($student->Exa3)}} "></td>
                                        ...
                                        <td><input maxlength="2"  type="text" name='total4_{{$student->user_id}}' id='total4_{{$student->user_id}}' min="0" required class="form-control" value="{{ ($student->Acum4) + ($student->Exa4)}} "></td>
                                        <td><input maxlength="2"  type="text" name='promedio_{{$student->user_id}}' id='promedio_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Promedio}} "></td>
