                            ...
                            <tbody id="tbody1" >
                                 @foreach ($students as $student)
                                    <tr>
                                        ...
                                        <td><input maxlength="2" disabled onchange="calcular_2P({{$student->user_id}})"type="text" name='acum2_{{$student->user_id}}' id='acum2_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Acum2}} "></td>
                                        <td><input maxlength="2" disabled onchange="calcular_2P({{$student->user_id}})"type="text" name='exa2_{{$student->user_id}}' id='exa2_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Exa2}} "></td>
                                        ...
                                        <td><input maxlength="2" disabled onchange="calcular_3P({{$student->user_id}})"type="text" name='acum3_{{$student->user_id}}' id='acum3_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Acum3}} "></td>
                                        <td><input maxlength="2" disabled onchange="calcular_3P({{$student->user_id}})"type="text" name='exa3_{{$student->user_id}}' id='exa3_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Exa3}} "></td>
                                        <td><input maxlength="2" disabled type="text" name='total3_{{$student->user_id}}' id='total3_{{$student->user_id}}' min="0" required class="form-control" value="{{ ($student->Acum3) + ($student->Exa3)}} "></td>
                                        <td><input maxlength="2" disabled onchange="calcular_4P({{$student->user_id}})"type="text" name='acum4_{{$student->user_id}}' id='acum4_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Acum4}} "></td>
                                        <td><input maxlength="2" disabled onchange="calcular_4P({{$student->user_id}})"type="text" name='exa4_{{$student->user_id}}' id='exa4_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Exa4}} "></td>
                                        <td><input maxlength="2" disabled type="text" name='total4_{{$student->user_id}}' id='total4_{{$student->user_id}}' min="0" required class="form-control" value="{{ ($student->Acum4) + ($student->Exa4)}} "></td>
                                        <td><input maxlength="2" disabled type="text" name='promedio_{{$student->user_id}}' id='promedio_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Promedio}} "></td>
                                        <td><input maxlength="2" disabled type="text" name='recu_{{$student->user_id}}' id='recu_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Recu1}} "></td>
