                            ...
                            <tbody id="tbody1" >
                                 @foreach ($students as $student)
                                    <tr>
                                        ...
                                        <td><input maxlength="2" disabled type="text" name='total1_{{$student->user_id}}' id='total1_{{$student->user_id}}' min="0" required class="form-control" value="( {{ (int)$student->Acum1}} + {{ (int)$student->Exa1}}) "></td>
