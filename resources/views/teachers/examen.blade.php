                            ...
                            <tbody id="tbody1" >
                                 @foreach ($students as $student)
                                    <tr>
                                        ...
                                        <td><input maxlength="2"  type="text" name='acum2_{{$student->user_id}}' id='acum2_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Acum2}} "></td>
                                        <td><input maxlength="2"  type="text" name='exa2_{{$student->user_id}}' id='exa2_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Exa2}} "></td>
                                        ...
                                        <td><input maxlength="2" disabled type="text" name='acum3_{{$student->user_id}}' id='acum3_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Acum3}} "></td>
                                        <td><input maxlength="2" disabled type="text" name='exa3_{{$student->user_id}}' id='exa3_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Exa3}} "></td>
                                        ...
                                        <td><input maxlength="2" disabled type="text" name='acum4_{{$student->user_id}}' id='acum4_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Acum4}} "></td>
                                        <td><input maxlength="2" disabled type="text" name='exa4_{{$student->user_id}}' id='exa4_{{$student->user_id}}' min="0" required class="form-control" value="{{$student->Exa4}} "></td>
