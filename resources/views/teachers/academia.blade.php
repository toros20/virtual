            ...
            <div class="col-md-6 col-sm-6 col-lg-3 mb-4">
                    ...
                    <div class="card gradient-card">
                        ...
                        <div class="card-body card-body-cascade ">
                           ...
                           @if ($modalidad ==1 )
                           <ul class="list-group">
                               <a class="list-group-item list-group-item-action" style="color:black" href="{{ $url = route('teachers/students/{user_id}/{course_id}/{section}', [$asignacion->user_id,$asignacion->course_id,$asignacion->section,$asignacion->clase_id])}} ">
