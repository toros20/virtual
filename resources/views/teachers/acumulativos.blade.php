                        ...
                        <div class="card card-cascade narrower">
                            ...
                            <div class="table-wrapper">
                                ...
                                <tbody id="tbody1" >
                                    ...
                                    <tr>
                                        ...
                                        @if ( $task->evaluada == 0)
                                            ...
                                            {{--<td><button onclick="#" type="button" class="btn btn-info btn-rounded btn-sm m-0">Evaluar</button></td>--}}
                                             ...
                                             <td><button onclick="ver_filetasks({{$clase_actual[0]->id}},{{$task->id}},{{$curso_actual[0]->id}},'{{$section_actual}}')" type="button" class="btn btn-primary btn-rounded btn-sm m-0">Tarea</button></td> 
                                    ...
                                    <div id="div_modal_ver_filetasks"></div>   
                                        ...
                                        <table class="table table-hover mb-0 table-responsive-md ">
                                            ...
                                            <tbody id="tbody_recursos" >
                                                ...
                                                <tr>  
                                                    ...
                                                    <td><button onclick="eliminar_enlace({{$enlace->id}})" type="button" class="btn btn-danger btn-rounded btn-sm m-0">Eliminar</button></td>
