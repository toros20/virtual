                    ...
                    <div class="card gradient-card">
                        ...
                        <div class="card-image" style="background-image: url(https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2814%29.jpg)">
                            ...
                            <!-- Content -->
                                ...
                                @if ($clase != $asignacion->clase_id)
                                    @php ($con += 1 ) 
                                        @if ($con>4)
                                         @php ($con = 1)                   
                                        @endif
                                    @php ($clase = $asignacion->clase_id ) 
                                @endif
                                ...
                                <h3 class="card-title"> {{$asignacion->clase}}  </h3>
                        ...
                        <div class="card-body card-body-cascade ">
                            ...
                            <ul class="list-group">
                                 ...
                                 <a class="list-group-item list-group-item-action" style="color:black" href="{{ $url = route('students/acumulativos/{user_id}/{clase}/{parcial}', [$user->id,$asignacion->clase_id,1])}} ">
                                ...
                                {{-- <a class="list-group-item list-group-item-action" style="color:black" href="">
                                    <li class="list-group-item">
                                        <div class="md-v-line"></div><i class="fas fa-user mr-5"></i>III Parcial
                                    </li>
                                </a>

                                <a class="list-group-item list-group-item-action" style="color:black" href="">
                                    <li class="list-group-item">
                                        <div class="md-v-line"></div><i class="fas fa-user mr-5"></i>IV Parcial
                                    </li>
                                </a> --}}
                              
                                   {{--  <a class="list-group-item list-group-item-action" style="color:black" href="">
                                        <li class="list-group-item">
                                            <div class="md-v-line"></div><i class="fas fa-user mr-5"></i>Docente
                                        </li>
                                    </a> --}}
                                   {{--  <a class="list-group-item list-group-item-action" style="color:black" href=" ">
                                        <li class="list-group-item">
