                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <form class="md-form" style="color: #757575;" enctype="multipart/form-data" method = 'POST' action="{{ route('students/send_file') }}">
                                                  ...
                                                  {{-- <input type="hidden" name="parcial" id="curso" value="{{$parcial}}">
                                                  <input type="hidden" name="parcial" id="seccion" value="{{$parcial}}"> --}}
                           ...
                           <div  class="card card-cascade narrower">
                              ...
                              <!--Card image-->
                                <div align="center" class="view view-cascade gradient-card-header purple-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                                    ...
                                    <h4 class="white-text mx-3">Enlaces del {{$parcial}} Parcial</h4>
