...
<body style="background-color:#f5f6f5">
        ...
        <div align="center" class="jumbotron" style="background-color:#fff; margin-top: 5% ">
            ...
            <p class="lead" >Los estudiantes BTP-I, primaria y las fotografías de último año, serán ingresados después de la semana Morazánica. </p>
                                ...
                                <div class="card-body">
                                  ...
                                  <table class="table">
                                    ...
                                    <div id="button_{{$excelencia->id}}">
                                        <a  onclick="felicitar_by_id({{$excelencia->id}})" class="btn btn-primary btn-block" style="color:white">Felicitaciones ({{$excelencia->felicitaciones}})</a>
                                    </div>
                                </div>
                        </div>
                </div>
